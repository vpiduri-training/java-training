  class BasicsDemoIntSopikzu {
	...
	static void primitives() {
	  ...
	  System.out.println("intBinary: " + intBinary); // Print statement to print out Binary code and convert to integer
	  int intChar = 'B'; // holds decimal equivalent, which is 66
	  ...
	  System.out.println("intUnderscore: " + intUnderscore); // Print statement for Underscore value.
    }
